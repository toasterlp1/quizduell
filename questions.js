...
const CATEGORIES = [
  ...
  // ========================================================
  {
    ...
    levels: {
      1: [
        ...
        { frage: "Wofür steht 'DVD' (grob)?", antwort: "Digital Versatile/Video Disc" },
        { frage: "Wofür steht 'SMS' (grob)?", antwort: "Short Message Service" },
      ],
      2: [
      ...
      3: [
        { frage: "Wofür steht 'HTML' (grob)?", antwort: "HyperText Markup Language" },
      ...
      4: [
        { frage: "Wofür steht 'NATO' (grob)?", antwort: "Nordatlantisches Verteidigungsbündnis" },
        { frage: "Wofür steht 'UNO/UN' (grob)?", antwort: "Vereinte Nationen" },
        { frage: "Wofür steht 'WWW'-Adressanfang 'HTTP' (grob)?", antwort: "HyperText Transfer Protocol" },
        { frage: "Wofür steht 'LED' (grob)?", antwort: "Licht emittierende Diode" },
        { frage: "Wofür steht 'WC'?", antwort: "Water Closet" },
      ],
      5: [
        { frage: "Wofür steht 'JPG/JPEG' (grob)?", antwort: "Bildformat (Joint Photographic Experts Group)" },
        { frage: "Wofür steht 'GIF' (grob)?", antwort: "Graphics Interchange Format" },
        { frage: "Wofür steht 'ABS' beim Auto (grob)?", antwort: "Antiblockiersystem" },
        { frage: "Wofür steht 'DJ'?", antwort: "Disc Jockey" },
        { frage: "Wofür steht 'FAQ' (grob)?", antwort: "Häufig gestellte Fragen" },
      ],
    },
  },
  ...
  // ========================================================
  {
    ...
    levels: {
      ...
      3: [
        ...
        { frage: "Welches Gas brauchen Pflanzen (atmen sie ein)?", antwort: "Kohlendioxid (CO₂)" },
  ...
  // ========================================================
  {
    ...
    levels: {
      1: [
        ...
        { frage: "Welche Bauwerke stehen in Ägypten (dreieckig)?", antwort: "Die Pyramiden" },
      ...
      2: [
        ...
        { frage: "Welche Königin regierte England sehr lange (gestorben 2022)?", antwort: "Elisabeth II." },
      ],
      3: [
        { frage: "In welchem Land stand die Berliner Mauer?", antwort: "Deutschland" },
        { frage: "Wer war ein berühmter französischer Kaiser (klein gewachsen)?", antwort: "Napoleon" },
  ...
  // ========================================================
  {
    ...
    levels: {
      1: [
        { frage: "In welchem Film geht es um einen Clownfisch namens Nemo?", antwort: "Findet Nemo" },
